...
static struct node *allocate_plan_node(const char *name, const char *eg, struct expr *exp, struct list *list);
...
static struct list * add_list_to_list (struct list *new_list, struct list *existing_list);
